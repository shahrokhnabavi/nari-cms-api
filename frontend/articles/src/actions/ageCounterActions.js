...
export const ageUp = stepUp => ({ type: AGE_UP, value: stepUp });
export const ageDown = stepDown => ({ type: AGE_DOWN, value: stepDown });
export const removeItemHistory = id => ({ type: REMOVE_ITEM_HISTORY, key: id });
